          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown"><a href="#" id="drop1" data-toggle="dropdown" class="dropdown-toggle underlineAnimate navbarText" role="button">'.$_SESSION['u_username'].'<b class="caret"></b></a>
                <ul role="menu" class="dropdown-menu" aria-labelledby="drop1">
                  ...
                  <li role="presentation"><a id="logout" href="#" role="menuitem">Log Out</a></li>
                </ul>
            </li>
            ...
            <li><form action="includes/logout.inc.php" method="POST">
              <li><button style="display:none;" id="logoutBtn" type="submit" name="logoutBtn">Log Out</button></li>
            </form></li>
          </ul>
        </div>
      </nav>';
